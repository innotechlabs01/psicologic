...
const ChatInterface = ({ ticketId, currentUserId, currentUserRole }) => {
    ...
    return (
        <div className="flex flex-col h-[70vh] bg-card dark:bg-gray-800 rounded-lg shadow-xl">
            {/* Header del Chat y Botón de Cierre (sin cambios) */}
            <div className="p-4 border-b dark:border-gray-700 flex justify-between items-center bg-muted/50 dark:bg-gray-700">
                {/* ... (código sin cambios) ... */}
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {messages.map((msg) => {
                    ...
                    const labelClass = isSenderClient ? 
                        ...
                        'text-foreground dark:text-white font-bold'; // Etiqueta del agente
                            ...
                            <div 
                                className={`max-w-xs lg:max-w-md px-4 py-2 rounded-xl shadow 
                                    ${isSenderClient 
                                        ...
                                        : 'bg-gray-200 text-foreground rounded-tl-none dark:bg-gray-600 dark:text-gray-100'}`
                                }
                            >
                                ...
                                {/* Timestamp */}
                                <p className={`text-xs mt-1 ${isSenderClient ? 'text-blue-200 dark:text-indigo-300' : 'text-muted-foreground dark:text-gray-300'} text-right`}>
            ...
            <form onSubmit={handleSend} className="p-4 border-t dark:border-gray-700 bg-muted/50 dark:bg-gray-700">
                {isTicketClosed ? (
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <label className="cursor-pointer text-muted-foreground hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400">
                        ...
                        <button 
                            type="submit" 
                            className="bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-lg font-bold transition disabled:bg-gray-400 dark:bg-indigo-500 dark:hover:bg-indigo-600 dark:disabled:bg-muted/500"
