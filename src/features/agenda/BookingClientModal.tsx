...
// Local skeleton aliases used for loading state
const SkeletonCard = () => <Skeleton className="h-24 w-full rounded-lg" />;
const SkeletonLine = ({ className }: { className?: string }) => <Skeleton className={`h-4 rounded ${className}`} />;
    ...
    if (result) {
        return (
            <div className="p-6 space-y-4 text-center">
                ...
                <p className="text-muted-foreground">Hemos enviado un correo a <span className="font-semibold">{email}</span></p>

                <div className="bg-muted p-4 rounded-lg my-4 text-left text-sm">
                ...
                <div className="grid gap-2">
                    ...
                    <a href={`mailto:${email}?subject=Confirmacion&body=Link: ${result.meetingLink}`} className="w-full flex items-center justify-center gap-2 p-2 bg-gray-200 rounded-md text-foreground">
